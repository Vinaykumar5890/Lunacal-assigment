...
const PhotoUpload = () => {
  ...
  const handleFileChange = e => {
    ...
    if (file) {
      const fileUrl = URL.createObjectURL(file) // Convert file into a URL
      setPhotos(prevPhotos => [...prevPhotos, fileUrl]) // Add URL to the list
    ...
    <div>
      <div className="photoContainer">
        <>
          ...
          <button className="buttonGallery">Gallery</button>
        </>
        <>

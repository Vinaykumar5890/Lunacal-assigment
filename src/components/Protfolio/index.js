...
class Protfolio extends Component {
  state = {about: true, experience: false, recommend: false}
  aboutme = () => {
    this.setState({about: true, experience: false, recommend: false})
  }
  experience = () => {
    this.setState({about: false, experience: true, recommend: false})
  }
  reccommend = () => {
    this.setState({about: false, experience: false, recommend: true})
  }

  render() {
    const {about, experience, recommend, photos} = this.state
    console.log(photos)
    return (
      <div className="bg-container ">
        <div className="container">
          ...
          <div className="container2">
            <div className="ProtfolioContainer">
              <div className="containerbuttons">
                ...
                <div className="buttonContainer">
                  <button
                    className={about ? 'active' : 'unActive'}
                    onClick={this.aboutme}
                  >
                    About
                  </button>
                  <button
                    className={experience ? 'active' : 'unActive'}
                    onClick={this.experience}
                  >
                    Experience{' '}
                  </button>
                  <button
                    className={recommend ? 'active' : 'unActive'}
                    onClick={this.reccommend}
                  >
                    Reccomended
                  </button>
                </div>
            ...
            <div className="ProtfolioContainer1">
              <PhotoUpload />
            </div>
          </div>
        </div>
